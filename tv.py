...
async def tv(update: Update, context: CallbackContext) -> None:
    keyboard = [
        [InlineKeyboardButton("Đổi ngôn ngữ", url='https://t.me/setlanguage/abcxyz')]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text("Bạn muốn đổi ngôn ngữ?", reply_markup=reply_markup)
